    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <p class="centered"><a href="profile.html"><img src="img/nes.jpg" class="img-circle" width="80"></a></p>
                <h5 class="centered">Nesrine Abdelkarim </h5>
                <li class="mt">
                    <a class="active" href="index.html">
                        <i class="fa fa-dashboard"></i>
                        <span>Heart2Hold</span>
                    </a>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-desktop"></i>
                        <span>Volunteers and events </span>
                    </a>
                    <ul class="sub">
                        <li><a href="buttons.html">ajouter  volentaire</a></li>
                        <li><a href="ajoucategorie.html">ajouter événement </a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
